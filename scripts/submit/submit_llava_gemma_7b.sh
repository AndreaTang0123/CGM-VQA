#!/bin/bash
#SBATCH --job-name=cgmvqa_llava_gemma
...
#SBATCH --mem=32G
#SBATCH --time=4:00:00
#SBATCH --output=logs/llava_gemma_%j.out
#SBATCH --error=logs/llava_gemma_%j.err
...
pip install -U -q transformers==4.42.4 "huggingface_hub==0.23.4" accelerate pillow protobuf tokenizers tiktoken sentencepiece
...
python3 scripts/eval/run_eval_llava_gemma_7b_hf.py
